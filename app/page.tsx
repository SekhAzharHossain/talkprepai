...
<div className="font-sans bg-gray-50 dark:bg-gray-950 dark:text-white min-h-screen flex flex-col">
      ...
      <section className="flex flex-col-reverse md:flex-row items-center px-6 md:px-20 py-16">
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <div className="space-x-4">
            <button className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
              Start Practicing
            </button>
            <button className="border border-blue-600 text-blue-600 dark:border-blue-400 dark:text-blue-400 px-6 py-3 rounded-lg hover:bg-blue-50 dark:hover:bg-gray-700">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section className="px-6 md:px-20 py-16 bg-blue-600 dark:bg-gray-950 text-white text-center">
        ...
        <button className="bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-50 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-600">
          Get Started Free
        </button>
      </section>
